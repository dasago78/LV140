...
class Detail extends React.Component<any, any> {
  ...
  backgroundImage: "url(../img/details/"+ this.state.id+".gif)" ,
  ...
  backgroundSize: 'cover'
                ...
                <h1 className="title">Nos gusta {this.state.id}</h1>
                        ...
                        <div className="row mt-5">
                            ...
                            <div className="col-lg-8">
                                <div className="video-container">
                                    <iframe className="video" src="https://www.youtube.com/embed/HcKkYAEh2U4" frameBorder="0" allowFullScreen></iframe>
                                </div>
                            </div>
                            <div className="col-lg-2">
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-6 text-left">
                                        <a href="/santander/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-left" viewBox="0 0 16 16">
                                            ...
                                            <img className="logo-detail-bottom" alt={this.state.id} title={this.state.id} src={"../img/logos/correos.png"} /></a>
